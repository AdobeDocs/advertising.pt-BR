---
title: Exibir o log de alterações de um criativo
description: Saiba como visualizar detalhes sobre as alterações em um criativo durante um intervalo de tempo especificado, incluindo quem fez a alteração.
...
ht-degree: 0%
---
# Exibir o log de alterações de um criativo
...
1. Clique na guia **[!UICONTROL Creatives]** e abra a guia **[!UICONTROL Standard Ads]** ou **[!UICONTROL Dynamic Ads]**.

1. Selecione o criativo:

   * Na exibição de cartão, clique em **[!UICONTROL ...]** ao lado do nome criativo e, em seguida, clique em **[!UICONTROL Change Log]**.
