...
| [!UICONTROL Dimension] | [!UICONTROL Ad] | [!UICONTROL Rotation Type] | Se os anúncios foram girados de forma algorítmica (*Algorítmica*), em uma sequência especificada (*Sequenciada*) ou de acordo com pesos relativos (*Ponderados*). |
