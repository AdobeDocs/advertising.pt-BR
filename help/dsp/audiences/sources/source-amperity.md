...
1. [Solicitar um push de dados de [!DNL Amperity] para o DSP](#push-data).
...
## Etapa 4: solicitar um push de dados de [!DNL Amperity] para a DSP {#push-data}

1. Depois que o segmento é mapeado no DSP, o anunciante deve trabalhar com o representante [!DNL Amperity] para distribuir os dados do segmento para a DSP.

1. O anunciante deve confirmar com a equipe de conta da Adobe que os dados do segmento foram recebidos.
...
Depois que a DSP receber os dados do segmento, o contagem de público-alvo deverá ficar visível dentro de nove (9) horas.
