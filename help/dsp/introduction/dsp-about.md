...
* [**Otimização**](features/optimization.md): seu novo destino para o gerenciamento de campanhas, [!DNL Campaign Home], oferece ferramentas avançadas, classificação e insights para otimizar suas campanhas mais rápido do que nunca. Além disso, as recomendações de previsão e gastos preveem as estratégias que devem ter bom desempenho, não necessariamente o que está tendo melhor desempenho no momento, para que você possa otimizar com os dados.
...
* [**A Premiere conectou a experiência de TV com [!DNL Roku]**](/help/dsp/inventory/roku-inventory.md): [!DNL Roku] e a DSP têm uma parceria exclusiva que permite ativar seus dados primários e de terceiros no inventário do [!DNL Roku]. Essa parceria permite alcançar públicos com eficiência em toda a tela, em escala. Ao aproveitar a única plataforma com a capacidade de sincronização com [!DNL Roku] IDs, os profissionais de marketing podem aproveitar o direcionamento determinístico de 1:1 com precisão e precisão. Os profissionais de marketing também podem acessar o inventário [!DNL Roku] e informações de medição exclusivas.

>[!MORELIKETHIS]
>
>* [Vídeo: Introdução ao Advertising DSP](https://experienceleague.adobe.com/pt-br/docs/advertising-learn/tutorials/dsp/intro)
>* [Vídeo: estrutura de conta e interface de usuário do DSP](https://experienceleague.adobe.com/pt-br/docs/advertising-learn/tutorials/dsp/ui)
