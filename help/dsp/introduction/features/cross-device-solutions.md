...
Com a atribuição baseada em pessoas, você pode atribuir conversões que ocorreram em um dispositivo diferente daquele no qual a exposição da mídia ocorreu. A medição de atribuição baseada em pessoas está disponível em todos os DSP, [!DNL Adobe Advertising Creative]e [!DNL Adobe Advertising Search, Social, & Commerce] para anunciantes que implementaram pixels de conversão de Adobe Advertising em seus sites.

### Ativar a medição de atribuição baseada em pessoas

Se você deseja ativar a medição de atribuição entre dispositivos, entre em contato com a Equipe da conta do Adobe.
