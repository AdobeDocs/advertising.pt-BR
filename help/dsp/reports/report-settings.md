...
**[!UICONTROL Select To Add As Report Headers]:**  As colunas de dados, ou cabeçalhos, a serem incluídos no relatório. Para adicionar uma coluna, expanda a categoria e marque a caixa de seleção ao lado do nome da coluna. Todas as métricas indisponíveis estão desabilitadas. As categorias de dados disponíveis incluem:
...
* *[!UICONTROL Display Only]:*  Conversões de atributos para o último clique ou impressão DSP no caminho de conversão. Isso inclui vídeo e anúncios de TV conectados e exclui cliques em [!DNL Adobe Advertising Search] anúncios.
