...
* [!UICONTROL Dimensions]
   ...
   >[!NOTE]
   >
   > O [!UICONTROL Household] relatório pode incluir apenas uma dimensão.

* [!UICONTROL Metrics]

   >[!NOTE]
   >
   >O [!UICONTROL Household] relatório pode incluir métricas de sobreposição ou métricas de não sobreposição, mas não ambas.
...
* *[!UICONTROL Display Only]:*  Atribui conversões ao último clique DSP ou impressão no caminho de conversão. Isso inclui vídeo e anúncios de TV conectados e exclui cliques em [!DNL Advertising Search, Social, & Commerce] anúncios.
