...
* O recurso de inserção do lado do servidor não está implementado:
   ...
   * Clientes de pesquisa, social e comércio:
      ...
      * Para anúncios em todas as outras redes de anúncios, manualmente [adicionar o parâmetro da ID do AMO aos parâmetros de acréscimo no nível da conta](/help/search-social-commerce/campaign-management/accounts/ad-network-account-manage.md){target="_blank"}, que o anexam aos URLs base.
