...
![Exemplo de dados do Adobe Advertising no Customer Journey Analytics](/help/integrations/assets/cja-report-example.png "Exemplo de dados do Adobe Advertising no Customer Journey Analytics")
