...
O Adobe Advertising é integrado ao Adobe Customer Journey Analytics para compartilhamento de dados bidirecional. Há duas opções para configurar a integração:
