...
| O código de inserção está ausente ou no ambiente incorreto | Verifique se o [[!DNL Tags] código incorporado](https://experienceleague.adobe.com/en/docs/experience-platform/tags/publish/environments/environments) na página da Web faz referência ao ambiente correto (Dev/Stage/Prod). Procure o ambiente na tag `<head>` para a tag de script `//assets.adobedtm.com/...`. |
| Conflito de carga assíncrono vs. síncrono | Verifique se apenas um [[!DNL Tags] código incorporado](https://experienceleague.adobe.com/en/docs/experience-platform/tags/publish/environments/environments) está presente por página da Web. Códigos incorporados duplicados causam condições de corrida. |
| Bloqueio da política de segurança de conteúdo (CSP) | Adicione `edge.adobedc.net` `and assets.adobedtm.com` às suas [diretivas CSP `connect-src` e `script-src`](https://experienceleague.adobe.com/en/docs/experience-platform/collection/use-cases/configuring-a-csp). |
...
* A regra foi salva e incluída na [build de biblioteca](https://experienceleague.adobe.com/en/docs/experience-platform/tags/publish/builds) ativa.
...
* As condições da regra não são muito restritivas. Teste [removendo condições](https://experienceleague.adobe.com/en/docs/experience-platform/tags/ui/rules) temporariamente para isolar o problema.
* A ordem da regra está correta. Se várias regras compartilharem o mesmo evento, verifique a [ordem das regras](https://experienceleague.adobe.com/en/docs/experience-platform/tags/ui/rules).
