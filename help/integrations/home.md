...
| ---- | ------- | ----------- | -------------------- |
| 16 de dezembro de 2023 | Ajuda | Um novo documento explica como configurar testes AB no [!DNL Target] para tráfego de click-through de anúncios em Search, Social e Commerce, bem como dicas sobre como medir e visualizar seus testes em [!DNL Analytics]. | Consulte &quot;[Configurar testes A/B no Adobe Target para anúncios de pesquisa, sociais e comércio](/help/integrations/target/ab-tests-search.md).&quot; |
