...
| ---- | ------- | ----------- | -------------------- |
| 19 de julho de 2023 | Relatórios | (Usuários de DSP com [!DNL Analytics for Advertising]) Conversões de view-through para inserções de TV conectada (CTV) agora estão disponíveis em um novo [!UICONTROL Household Conversions Report]. Anteriormente, eles eram incluídos somente no Adobe Analytics. | Consulte &quot;[Perguntas frequentes sobre relatórios domésticos](/help/dsp/reports/faq-household-report.md).&quot; |
