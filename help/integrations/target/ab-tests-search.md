...
## Etapa 2: configurar o Analysis Workspace do [!DNL Analytics for Target] no [!DNL Analytics]
...
>[!MORELIKETHIS]
>
>* [Configurar testes A/B no Adobe Target para anúncios do Advertising DSP](ab-tests-dsp.md)
