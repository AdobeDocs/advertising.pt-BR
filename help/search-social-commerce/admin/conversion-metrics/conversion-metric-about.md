...
* No Advertising DSP, você pode usar as métricas de conversão para [criar objetivos personalizados](/help/dsp/admin/custom-objectives-manage.md), que são usados para otimizar pacotes.
