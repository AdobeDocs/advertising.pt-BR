...
|  | [!UICONTROL Trigger this Alert] [quando] | Com que frequência o alerta verifica os filtros de condição especificados e, quando todas as condições são atendidas, envia notificações por email:<ul><li><p>[!UICONTROL Daily at <*NN*> [AMPM]]</p></li><li><p>[!UICONTROL Weekly on <*Day of Week*> at <*NN*> [AMPM]]</p></li><li><p>[!UICONTROL Every month on <*Day NN*> at <*NN*> [AMPM]]</p></li></ul>**Nota:** Esse valor não afeta o período de avaliação. |
