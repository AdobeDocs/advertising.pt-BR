...
*[!DNL Google Ads], [!DNL LY Ads] (antigo [!DNL Yahoo! Japan Ads]), [!DNL Microsoft Advertising] (antigo [!DNL Bing Ads]), [!DNL Yahoo DSP] (antigo [!DNL Yahoo! Display Network]), [!DNL Yandex] e contas [!DNL Baidu] existentes*
