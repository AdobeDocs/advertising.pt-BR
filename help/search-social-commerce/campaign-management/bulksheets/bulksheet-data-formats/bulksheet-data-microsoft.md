...
| Tipo de localização | O tipo de local, como Cidade, País, MetroArea, Código Postal e Estado. Para baixar uma lista de locais, faça logon na [!DNL Microsoft Advertising] portal do desenvolvedor usando o [!DNL Microsoft Advertising] credenciais da conta de publicidade. |
...
| ID do local | O único [!DNL Microsoft Advertising] identificador do destino de localização. Para baixar uma lista de locais, faça logon na [!DNL Microsoft Advertising] portal do desenvolvedor usando o [!DNL Microsoft Advertising] credenciais da conta de publicidade. Obrigatório somente quando você altera ou exclui o alvo do local, a menos que a linha inclua uma &quot;ID do AMO&quot; para o alvo. |
