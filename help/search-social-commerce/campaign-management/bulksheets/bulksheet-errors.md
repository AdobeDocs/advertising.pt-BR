...
Os seguintes erros podem ser incluídos na variável [!UICONTROL EF Error] coluna em [!UICONTROL EF Errors] arquivos.
...
Os seguintes erros ocorrem em [!UICONTROL EF Errors] somente arquivos. A maioria dos erros de publicação vem da rede de publicidade e é incluída em um arquivo de erros SE.
