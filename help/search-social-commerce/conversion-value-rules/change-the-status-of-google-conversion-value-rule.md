---
title: 'Alterar o status de uma regra de valor de conversão  [!DNL Google Ads] '
description: Saiba como alterar o status de  [!DNL Google Ads] regras de valor de conversão.
...
# Alterar o status de uma regra de valor de conversão [!DNL Google Ads]
