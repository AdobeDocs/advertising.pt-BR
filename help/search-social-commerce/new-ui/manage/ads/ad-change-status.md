---
title: (Nova interface do usuário) Alterar o status de um anúncio
description: Saiba como alterar o status de um anúncio sem abrir as configurações do anúncio.
...
# (Nova interface do usuário) Alterar o status de um anúncio
...
>[!MORELIKETHIS]
>
>* [(Nova interface do usuário) Sobre a [!UICONTROL Ads] exibição](ad-view-about.md)
