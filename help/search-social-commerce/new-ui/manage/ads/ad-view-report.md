...
# (Nova interface do usuário) Gerenciar relatórios de visualização de dados da visualização [!UICONTROL Ads]

*recurso do Beta*

Você pode gerar um relatório que inclua as linhas de dados de um ou mais anúncios na exibição [!UICONTROL Ads] e depois baixar o relatório como um arquivo de planilha do Microsoft Excel (formato XLXS). O relatório inclui todas as colunas visíveis na visualização.
