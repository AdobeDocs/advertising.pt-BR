---
title: (Nova interface) Alterar o status de uma campanha
description: Saiba como alterar o status de uma campanha sem abrir as configurações dela.
...
# (Nova interface) Alterar o status de uma campanha
