...
1. (Opcional) No menu **[!UICONTROL Data Aggregation]**, altere a unidade de tempo dos dados incluídos em cada linha: *[!UICONTROL Daily],* *[!UICONTROL Weekly],* ou *[!UICONTROL Monthly].*
