...
>* Para renomear rapidamente um portfólio sem abrir as configurações completas do portfólio, consulte &quot;[Renomear um portfólio](/help/search-social-commerce/new-ui/manage/portfolios/portfolio-rename.md)&quot;.

1. No menu principal, clique em **[!UICONTROL Manage]>[!UICONTROL Portfolios]**.

1. Siga um destes procedimentos:

   * Mantenha o cursor sobre a linha do portfólio e clique em ![Editar Portfolio](/help/search-social-commerce/assets/settings-new.png "Editar Portfolio").

   * Marque a caixa de seleção ao lado do portfólio. Na barra de ferramentas de ações em massa, clique em ![Editar](/help/search-social-commerce/assets/edit.png "Editar").
