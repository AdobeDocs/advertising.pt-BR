...
* Entre em contato com a equipe de conta da Adobe para configurar uma conta FTP para acesso ao relatório.

  A equipe fornece seu nome de usuário e senha.

## Configurar modelos de relatório para entrega por FTP

Para gerar relatórios no diretório FTP designado, crie um [modelo de relatório](report-templates-manage.md) com o agendamento e as convenções de nomenclatura a seguir.
