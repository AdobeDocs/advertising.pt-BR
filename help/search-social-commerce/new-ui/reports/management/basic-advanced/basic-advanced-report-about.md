...
* [O [!UICONTROL Portfolio Report]](portfolio-report.md)

* [O [!UICONTROL Search Engine Report]](search-engine-report.md)

* [O [!UICONTROL Search Engine Account Report]](search-engine-account-report.md)

* [O [!UICONTROL Campaign Report]](campaign-report.md)

* [O [!UICONTROL Campaign Hourly Report]](campaign-hourly-report.md)

* [O [!UICONTROL Ad Group Report]](ad-group-report.md)

* [O [!UICONTROL Ad Variation Report]](ad-variation-report.md)
...
* [O [!UICONTROL Label Classification Report]](label-classification-report.md)

* [O [!UICONTROL Label Value Report]](label-value-report.md)

### Relatórios de restrição

* [O [!UICONTROL Constraint Report]](constraint-report.md)

* [O [!UICONTROL Network Constraint Report]](network-constraint-report.md)
...
* [O [!UICONTROL Domain Referral Report]](domain-referral-report.md)

* [O [!UICONTROL Geo Distribution Report]](geo-distribution-report.md)

* [O [!UICONTROL Transaction Report]](transaction-report.md)
...
>* [Colunas de relatório para relatórios básicos e avançados](basic-advanced-report-columns.md)
