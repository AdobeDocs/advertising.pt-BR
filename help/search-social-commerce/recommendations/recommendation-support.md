...
| | [!UICONTROL Improve performance max ad strength] | Melhore a força do grupo de ativos de uma campanha de desempenho máximo para que ela tenha uma classificação &quot;Excelente&quot;. |
...
| | [!UICONTROL Maximize clicks opt in] | Lance com [!UICONTROL Maximize Clicks] |
| | [!UICONTROL Maximize conversions opt in] | Lance com [!UICONTROL Maximize Conversions] |
...
| Categoria de recomendação | Tipo de recomendação | Descrição |
| --- | --- | --- |
| [!UICONTROL Ads and extensions] | [!UICONTROL Responsive search ad] | Adicionar novo anúncio de pesquisa responsivo |
