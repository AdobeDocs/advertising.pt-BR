...
+ (Beta) NOVA INTERFACE DO USUÁRIO {#new-ui}
   ...
   + Gerenciar {#manage}
      ...
      + Anúncios {#ads}
         ...
         + [Alterar o status de um anúncio](/help/search-social-commerce/new-ui/manage/ads/ad-change-status.md)
   + Relatórios {#reports}
   ...
   + Rastreamento de cliques {#click-tracking}
      ...
      + Componentes de URLs de rastreamento de cliques {#click-tracking-components}
         + Formatos padrão para URLs de rastreamento de cliques {#click-tracking-formats}
            ...
            + [Formatos de rastreamento de cliques para  [!DNL LY Ads]](/help/search-social-commerce/tracking/formats-click-tracking-yahoo-japan.md)
   ...
   + Gerenciar campanhas {#management}
      ...
      + Gerenciando dados nas [!UICONTROL Campaigns] > [!UICONTROL Campaigns] visualizações {#campaigns}
         ...
         + Palavras-chave {#keywords}
            ...
            + Configurações de palavra-chave por rede de publicidade {#keyword-settings-by-network}
               ...
               + [Configurações de palavra-chave [!DNL LY Ads]](/help/search-social-commerce/campaign-management/campaigns/keyword-settings-yahoo-japan.md)
      ...
      + Gerenciamento de dados em massa por meio de bulksheets {#bulksheets}
         ...
         + Dados obrigatórios/incluídos em bulksheets{#bulksheet-data-formats}
            ...
            + [Dados de bulksheet para  [!DNL LY Ads] contas](/help/search-social-commerce/campaign-management/bulksheets/bulksheet-data-formats/bulksheet-data-yahoo-japan.md)
            ...
            + [Dados de bulksheet para  [!DNL Yahoo DSP] contas](/help/search-social-commerce/campaign-management/bulksheets/bulksheet-data-formats/bulksheet-data-yahoo-display-network.md)
