...
index: true
source-git-commit: 49debc4d3a5cffce5dcaf698f254bc116deb36ec
workflow-type: tm+mt
...
+ Tarefas comuns {#common-tasks}
   + [Visualizar dados de outro anunciante](/help/search-social-commerce/common-tasks/change-advertiser.md)
   + [Editar configurações diretamente em uma linha](/help/search-social-commerce/common-tasks/settings-edit-within-row.md)
   + Personalizar exibições de dados {#data-views}
      + [Sobre a personalização de dados em exibições de gerenciamento de campanha](/help/search-social-commerce/common-tasks/data-views/data-views-about.md)
   ...
   + Tarefas comuns de navegação, edição e seleção {#navigation-editing-selection}
      ...
      + Baixar dados nos modos de exibição de gerenciamento {#download-data-views}
...
+ (Beta) NOVA INTERFACE DO USUÁRIO {#new-ui}
   ...
   + Gerenciar {#manage}
      + Portfolio {#portfolios}
         ...
         + [configurações de Portfolio](/help/search-social-commerce/new-ui/manage/portfolios/portfolio-settings.md)
         ...
         + [Exibir detalhes do desempenho do portfólio](/help/search-social-commerce/new-ui/manage/portfolios/portfolio-details.md)
         + [Gerenciar relatórios de exibição de dados da exibição [!UICONTROL Portfolios]](/help/search-social-commerce/new-ui/manage/portfolios/portfolio-view-report.md)
      + Campanhas {#campaigns}
         ...
         + [Exibir um gráfico de desempenho na exibição [!UICONTROL Campaigns]](/help/search-social-commerce/new-ui/manage/campaigns/campaign-view-performance-graph.md)
      ...
      + Grupos de anúncios {#ad-groups}
         ...
         + [Exibir um gráfico de desempenho na exibição [!UICONTROL Ad Groups]](/help/search-social-commerce/new-ui/manage/ad-groups/ad-group-view-performance-graph.md)
   ...
   + Relatórios {#reports}
      + Classificações de rótulo {#label-classifications}
         + [Sobre as classificações de rótulo](https://experienceleague.adobe.com/en/docs/advertising/search-social-commerce/campaign-management/label-classifications/classification-about)
         + [Criar uma classificação de etiqueta](https://experienceleague.adobe.com/en/docs/advertising/search-social-commerce/campaign-management/label-classifications/classification-create)
         + [Atribuir valores de classificação aos componentes da conta das exibições de gerenciamento de campanha](https://experienceleague.adobe.com/en/docs/advertising/search-social-commerce/campaign-management/label-classifications/classification-values-assign-campaign-management)
         + [Atribuir valores de classificação aos componentes da conta usando bulksheets](https://experienceleague.adobe.com/en/docs/advertising/search-social-commerce/campaign-management/label-classifications/classification-values-assign-bulksheets)
         + [Remover os valores de classificação de etiquetas dos componentes da conta](https://experienceleague.adobe.com/en/docs/advertising/search-social-commerce/campaign-management/label-classifications/classification-values-remove)
         + [Excluir valores de classificação de etiquetas](https://experienceleague.adobe.com/en/docs/advertising/search-social-commerce/campaign-management/label-classifications/classification-values-delete)
         + [Excluir classificações de etiquetas](https://experienceleague.adobe.com/en/docs/advertising/search-social-commerce/campaign-management/label-classifications/classification-delete)
   + Configuração {#setup}
      + Contas {#accounts}
         ...
         + Públicos-alvo e metas de público-alvo {#audiences-and-targets}
            + Públicos-alvo {#audiences}
               ...
               + Metas e exclusões de público {#audience-targets}
                  ...
                  + [Gerenciar exclusões de público para campanhas e grupos de anúncios](/help/search-social-commerce/campaign-management/campaigns/audience-exclusions-manage.md)
   ...
   + Relatórios {#reports}
      ...
      + Gerenciamento de relatórios {#report-management}
         + Relatórios básicos e avançados {#basic-advanced-reports}
            ...
            + [Configurações de relatório básicas e avançadas](/help/search-social-commerce/reports/management/basic-advanced/basic-advanced-report-settings.md)
      ...
      + Automatizar relatórios {#report-automation}
         ...
         + Fontes de Planilhas {#spreadsheet-feeds}
            + [Sobre feeds de relatórios de planilhas](/help/search-social-commerce/reports/automation/spreadsheet-feeds/spreadsheet-feed-about.md)
            ...
            + [Configurações do feed de relatório da planilha](/help/search-social-commerce/reports/automation/spreadsheet-feeds/spreadsheet-feed-settings.md)
...
+ Ferramentas {#tools}
   ...
   + Ferramentas para criar e decodificar tags de rastreamento{#tracking}
      ...
      + [Gerar uma tag de conversão do Adobe Advertising](/help/search-social-commerce/tools/conversion-tag-generate.md)
...
+ Administração {#admin}
   ...
   + [Gerenciar credenciais para contas de gerenciador de rede de anúncios](/help/search-social-commerce/admin/manager-accounts.md)
