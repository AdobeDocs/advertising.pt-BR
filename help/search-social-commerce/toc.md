...
+ (Beta) NOVA INTERFACE DO USUÁRIO {#new-ui}
   ...
   + Relatórios {#reports}
      + Classificações de rótulo {#label-classifications}
         ...
         + [Remover os valores de classificação de etiquetas dos componentes da conta](https://experienceleague.adobe.com/pt-br/docs/advertising/search-social-commerce/campaign-management/label-classifications/classification-values-remove)
         + [Excluir valores de classificação de etiquetas](https://experienceleague.adobe.com/pt-br/docs/advertising/search-social-commerce/campaign-management/label-classifications/classification-values-delete)
         + [Excluir classificações de etiquetas](https://experienceleague.adobe.com/pt-br/docs/advertising/search-social-commerce/campaign-management/label-classifications/classification-delete)
   + Configuração {#setup}
      + Contas {#accounts}
