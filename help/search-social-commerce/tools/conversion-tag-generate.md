...
## (Nova interface) Gerar e implementar uma tag de rastreamento de conversão no Search, Social e Commerce
...
## (Interface herdada) Gerar e implementar uma tag de rastreamento de conversão no Search, Social e Commerce
...
1. Especifique as [configurações da marca de conversão](#conversion-tag-settings-legacy).
...
### Configurações da tag de conversão do Adobe Advertising {#conversion-tag-settings-legacy}
