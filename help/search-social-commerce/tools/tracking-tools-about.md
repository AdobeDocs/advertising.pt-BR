...
description: Saiba mais sobre as ferramentas para criar tags de rastreamento de conversão do Adobe Advertising e tags de rastreamento de cliques do Search, Social e Commerce e como decodificar tags de rastreamento de cliques existentes.
...
Se você usar o serviço de rastreamento de conversão da Adobe Advertising, poderá criar e decodificar tags de rastreamento usando as seguintes ferramentas:

* A ferramenta [[!UICONTROL Conversion Tags]](conversion-tag-generate.md) permite gerar manualmente tags de rastreamento de conversão do Adobe Advertising para adicionar às páginas de &quot;sucesso&quot; ou &quot;obrigado&quot; em seus sites.

  >[!NOTE]
  >
  >A Equipe de conta da Adobe geralmente fornece tags de rastreamento de conversão do Adobe, portanto, talvez você não precise desse recurso.
...
>[!MORELIKETHIS]
>
>* [Gerar uma marca de conversão do Adobe Advertising](conversion-tag-generate.md)
