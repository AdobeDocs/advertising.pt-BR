...
Você pode [gerar tags de rastreamento de conversão](/help/search-social-commerce/tools/conversion-tag-generate.md) no Search, Social e Commerce ou usar tags na Adobe Experience Platform (anteriormente conhecida como Adobe Experience Platform Launch).

>[!NOTE]
>
>Se o usuário não tiver um cookie válido, a Adobe Advertising não relatará a conversão.

Para cada conjunto de métricas de conversão que você deseja rastrear, é necessário criar e implementar uma tag de conversão separada. Você pode gerar qualquer um dos seguintes tipos de tags de conversão.

* (Recomendado) Tags do JavaScript (Versão 3 ou Versão 2), que não estão visíveis nas páginas da Web.

* Marcas de imagem do HTML para exibir imagens transparentes (pixels) de 1 pixel x 1 pixel, que são invisíveis para os usuários finais, nas páginas da Web. Use tags de imagem somente quando a empresa tiver uma política contra o uso de tags da JavaScript.

Para obter mais informações sobre as diferenças entre os tipos de tags, consulte &quot;[Perguntas frequentes sobre tags de rastreamento de conversão da Advertising Cloud](/help/search-social-commerce/tracking/faqs-conversion-page-view-tracking-tags.md).&quot;
...
* Forneça visibilidade sobre as assistências a cliques (palavras-chave de pesquisa ou disposições que contribuíram para um funnel de conversão) e assistências de canal (eventos de usuário que contribuíram para um funnel de conversão, possivelmente em vários canais de marketing).
...
>* [Gerar e implementar uma marca de conversão do Adobe Advertising](/help/search-social-commerce/tools/conversion-tag-generate.md)
