---
title: Formatos de rastreamento de cliques para  [!DNL LY Ads]
description: Saiba mais sobre os formatos de rastreamento de cliques para contas do  [!DNL LY Ads] .
...
# Formatos de rastreamento de cliques para anúncios patrocinados em [!DNL LY Ads]

Os seguintes formatos de modelo de rastreamento base se aplicam aos anúncios patrocinados:

`http://pixel.everesttech.net/<advertiser_ID>/cq?ev_sid=<ad network ID>&ev_ln={keyword}&ev_crx={creative}&ev_mt={matchtype}&ev_n={network}&ev_dvc={device}&url=!{unescapedlpurl}`

ou, quando a opção de marcação automática estiver definida para a conta em [!DNL LY Ads]:
